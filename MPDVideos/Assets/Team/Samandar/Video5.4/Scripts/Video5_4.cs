...
namespace Samandar
{
    public class Video5_4 : Introduction
    {
        ...
        IEnumerator PageController_4()
        {
            ...
            Page_4[3].GetComponent<RectTransform>().DOAnchorPosY(240, 1);
            yield return new WaitForSeconds(3);
            Page_4[4].SetActive(false);
            Page_4[6].SetActive(true);
            Page_4[5].SetActive(true);
            Page_4[5].GetComponent<RectTransform>().DOAnchorPosY(182, 1);
            yield return new WaitForSeconds(4);
            ...
            Page_4[10].GetComponent<RectTransform>().DOScale(1, 0.5f);
            yield return new WaitForSeconds(0.5f);
            Page_4[11].SetActive(true);
            Page_4[11].GetComponent<RectTransform>().DOScale(1, 0.5f);
            yield return new WaitForSeconds(6);
            Page_4[7].SetActive(false);
            Page_4[11].GetComponent<RectTransform>().DOScale(0.5f, 0.5f);
            Page_4[11].GetComponent<RectTransform>().DOAnchorPos(new Vector2(410, -7), 0.5f);
            yield return new WaitForSeconds(0.5f);
            Page_4[10].GetComponent<RectTransform>().DOScale(0.5f, 0.5f);
            Page_4[10].GetComponent<RectTransform>().DOAnchorPos(new Vector2(510, -333), 0.5f);
            yield return new WaitForSeconds(10);
            Page_4[12].SetActive(true);
            Page_4[12].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            Page_4[13].SetActive(true);
            Page_4[13].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            Page_4[14].SetActive(true);
            Page_4[14].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            Page_4[15].SetActive(true);
            Page_4[15].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            Page_4[16].SetActive(true);
            Page_4[16].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            Page_4[17].SetActive(true);
            Page_4[17].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            Page_4[18].SetActive(true);
            Page_4[18].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1f);
            Page_4[19].SetActive(true);
            Page_4[19].GetComponent<RectTransform>().DOScale(1, 1);
            yield return new WaitForSeconds(1);
            //Page_4[6].SetActive(true);
